...
شاید هوش مصنوعی به خودی خود خیلی نوظهور نباشد، اما پیشرفت چشمگیر آن که باعث شده علوم دیگر، از جمله زیست‌شناسی، را تحت تأثیر قرار دهد، پدیده‌ای تازه است. به همین علت، دسترسی به منبع و کتاب بین‌رشته‌ای با رویکردی کاربردی در علوم زیستی و سلامت، که منطبق با دانش و مهارت‌های ما باشد، بسیار محدود و بعضاً غیرمؤثر است. به همین دلیل به نظرم رسید که شاید خوب باشد با اتصال تجربه‌هایی که در هر دو حوزه علوم زیستی و علوم کامپیوتر و هوش مصنوعی دارم، این کتاب را بنویسم تا هم زیربنای محتوای مورد بررسی ما در طول کلاس‌های دوره باشد و هم شاید منبعی قابل استفاده برای سایر علاقه‌مندان و دانشجویان علوم زیستی و سلامت برای یادگیری کاربردی‌تر هوش مصنوعی فراهم شود.

این دوره (و کتاب) برای آن نیست که به یک برنامه‌نویس حرفه‌ای تبدیل شویم. هدف، بسیار فراتر از آن است! هدف این است که هر کدام از ما به سمت تبدیل شدن به یک **متفکر محاسباتی** حرکت کنیم. تمرکز بیشتر این دوره، تلاشی عمیق‌تر از گذشته برای یاد گرفتن آن است که چگونه:
...
* و از همه مهم‌تر، سؤال درست و به شیوه درست بپرسیم تا هوش مصنوعی پاسخ بهتر و مفیدتری به ما بدهد.
