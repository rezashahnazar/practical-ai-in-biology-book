...
در این دوره (و کتاب)، قرار نیست به یک برنامه‌نویس حرفه‌ای تبدیل شوید. هدف، بسیار فراتر از این است! هدف ما این است که هر کدام از ما به سمت تبدیل شدن به یک **متفکر محاسباتی** حرکت کنیم. در این دوره شما یاد خواهید گرفت که چگونه:

- یک مسئله پیچیده زیستی را به اجزای قابل تحلیل تقسیم کنید.
- با نگرشی نقادانه به داده‌ها نگاه کنید و الگوهای اولیه را کشف کنید.
