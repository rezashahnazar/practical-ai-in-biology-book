<div align="center">
  <img src="practical-ai-in-biology.png" alt="کتاب هوش مصنوعی کاربردی در زیست‌شناسی" width="600"/>
  <br/>
...
به دوره تابستان المپیاد زیست‌شناسی خوش آمدید. شما در مسیری قدم گذاشته‌اید که نیازمند ذهنی کنجکاو، نگاهی دقیق و روحیه‌ای خستگی‌ناپذیر است. شما از بهترین‌های کشور در درک عمیق و کاربردی مفاهیم حیات هستید. برای من، فرصت همراهی با شما پس از سال‌ها دوری از فضای شیرین المپیاد زیست‌شناسی، بسیار جذاب، ارزشمند و اثربخش است. در این همراهی، قرار است با تحولی نوظهور و بزرگ آشنا شویم که احتمالاً تعاریف و ابعاد پژوهشی و کاربردی علوم زیستی را برای همیشه تغییر خواهد داد: تحول دنیای زیست‌شناسی با هوش مصنوعی.
...
واقعیت این است که هوش مصنوعی شاید در مفهوم خود چندان نوظهور نباشد، اما پیشرفت‌های چشمگیر اخیر آن که علوم مختلفی از جمله زیست‌شناسی را تحت تأثیر قرار داده است، پدیده‌ای واقعاً تازه است. به همین دلیل، دسترسی به منابع و کتاب‌های میان‌رشته‌ای با رویکردی کاربردی در علوم زیستی و سلامت، که همزمان با دانش و مهارت‌های مورد نیاز ما منطبق باشد، بسیار محدود و چالش‌برانگیز است. با توجه به تجربیاتی که در هر دو حوزه علوم زیستی و علوم کامپیوتر و هوش مصنوعی کسب کرده‌ام، به این نتیجه رسیدم که شاید نوشتن این کتاب بتواند مفید باشد. هدفم این بوده که هم زیربنای محتوای مورد بررسی ما در طول کلاس‌های این دوره باشد و هم شاید منبعی قابل استفاده برای سایر علاقه‌مندان و دانشجویان علوم زیستی و سلامت برای یادگیری کاربردی‌تر هوش مصنوعی فراهم کند.
این دوره (و کتاب) برای آن نیست که شما را به یک برنامه‌نویس حرفه‌ای تبدیل کند. هدف، بسیار فراتر از آن است! هدف این است که هر کدام از ما به سمت تبدیل شدن به یک متفکر محاسباتی حرکت کنیم. تمرکز اصلی این دوره، تلاشی عمیق‌تر از گذشته برای یاد گرفتن این است که چگونه:
 ...
 * و از همه مهم‌تر، سوال درست را به شیوه درست بپرسیم تا هوش مصنوعی پاسخ بهتر و مفیدتری به ما بدهد.
...
این کتاب، دعوت‌نامه‌ای است برای ورود به این دنیای جدید و هیجان‌انگیز. سفری که در آن، شما نه تنها مصرف‌کننده دانش، بلکه خالق راه‌حل‌های نوآورانه برای بزرگترین چالش‌های سلامت انسان و حیات تمامی موجودات زنده، دست کم در سیاره زمین (!) خواهید بود.
